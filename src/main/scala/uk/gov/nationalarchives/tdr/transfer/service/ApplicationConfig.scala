...
object ApplicationConfig {
  ...
  case class S3(metadataUploadBucket: String, recordsUploadBucket: String, metadataFileName: String)
  ...
  case class Configuration(auth: Auth, sns: Sns, sfn: Sfn, transferServiceApi: TransferServiceApi, transferService: TransferService, consignmentApi: ConsignmentApi, s3: S3)
