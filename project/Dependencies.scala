...
object Dependencies {
  ...
  private val tapirVersion = "1.11.12"
  ...
  lazy val graphqlClient = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.203"
  ...
  lazy val metadataSchema = "uk.gov.nationalarchives" % "da-metadata-schema_3" % "0.0.43"
