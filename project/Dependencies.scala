...
object Dependencies {
  ...
  private val tapirVersion = "1.11.4"
  ...
  lazy val graphqlClient = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.180"
  ...
  lazy val metadataSchema = "uk.gov.nationalarchives" % "da-metadata-schema_3" % "0.0.31"
