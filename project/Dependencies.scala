...
object Dependencies {
  ...
  private val tapirVersion = "1.13.18"
  ...
  lazy val graphqlClient = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.296"
  ...
  lazy val tdrAuthorisation = "uk.gov.nationalarchives" %% "tdr-authorisation" % "0.0.21"
