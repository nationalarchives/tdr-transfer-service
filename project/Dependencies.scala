...
object Dependencies {
  ...
  private val tapirVersion = "1.11.41"
  ...
  lazy val metadataSchema = "uk.gov.nationalarchives" % "da-metadata-schema_2.13"% "0.0.81-SNAPSHOT"
  ...
  lazy val snsUtils = "uk.gov.nationalarchives" %% "sns-utils" % "0.1.289"
}
